...
* **Hostname:** In der Regel wird die **Standardwebsite** mit dem **Hostnamen** `localhost` verwendet. Allerdings funktioniert jede gültige IIS-Website mit einem eindeutigen Hostnamen.
* **Sitebindung**
