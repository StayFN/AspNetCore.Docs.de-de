...
Blazor WebAssembly<span data-ttu-id="6868a-141"> bietet zwei zusätzliche Versionen von <xref:Microsoft.JSInterop.IJSRuntime> zusätzlich zur einzelnen für Blazor Server-Apps verfügbaren Version:</span><span class="sxs-lookup"><span data-stu-id="6868a-141"> offers two additional versions of <xref:Microsoft.JSInterop.IJSRuntime> over the single version available to Blazor Server apps:</span></span>
